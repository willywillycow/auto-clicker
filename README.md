...
*The hotkey and key may be set to multiple keys by pressing return / enter ⏎ after each input. To exit the session simply press on the button again.*
